...
<center style="width:100%;background-color:orange;color:#fff;margin-top:20px">PROFORMA RECEIVING</center>
	...
	<tr style="text-align:center">
      ...
      <table style="border-collapse:collapse; font-size:10px;">
        ...
        <tr>
          <td>Nama</td>
          <td>: </td>
          <td>PT. Musi Kali Jaya</td>
        </tr>
        <tr>
          <td>Alamat</td>
          <td>: </td>
          <td>Jl. Jendral Sudirman No 3528<br>RT 027 KM 3.5</td>
        </tr>
        <tr>
          <td>NPWP</td>
          <td>: </td>
...
<table  width="100%" align="center" border="1" cellspacing="1" cellpadding="2" style="border-collapse:collapse; font-size:10px;margin-top:20px">
	<tr style="text-align:center">
		<th rowspan="2" width="10%">NO BL</th>
  ...
  <tr>
    ...
    <td style="border-right: 0;border-bottom: 0;width:50%" colspan="7"></td>
  ...
  <tr>
    ...
    <td style="border-right: 0;border-top: 0;border-bottom:0;width:50%" colspan="7"></td>
  ...
  <tr>
    ...
    <td style="border-right: 0;border-top: 0;width:50%" colspan="7"></td>
