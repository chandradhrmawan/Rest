    ...
    */
    ...
    'connections' => [
        ...
        'mdm' => [
            ...
            'password'      => env('DB_PASSWORD', 'billing_mdm'),
        ...
        'omuster' => [
            ...
            'password'      => env('DB_PASSWORD', 'billing_order'),
            'charset'       => env('DB_CHARSET', 'AL32UTF8'),
            'prefix'        => env('DB_PREFIX', ''),
            'prefix_schema' => env('DB_SCHEMA_PREFIX', ''),
            'edition'       => env('DB_EDITION', 'ora$base'),
        ...
        'omcargo' => [
            ...
            'password'      => env('DB_PASSWORD', 'billing_order_npk'),
            'charset'       => env('DB_CHARSET', 'AL32UTF8'),
            'prefix'        => env('DB_PREFIX', ''),
            'prefix_schema' => env('DB_SCHEMA_PREFIX', ''),
            'edition'       => env('DB_EDITION', 'ora$base'),
        ...
        'eng' => [
            ...
            'password'      => env('DB_PASSWORD', 'billing_engine'),
            'charset'       => env('DB_CHARSET', 'AL32UTF8'),
            'prefix'        => env('DB_PREFIX', ''),
            'prefix_schema' => env('DB_SCHEMA_PREFIX', ''),
            'edition'       => env('DB_EDITION', 'ora$base'),
